...
| stonehide_005        | Art/Dragons/stonehide_005/portrait.png       | Stocky mossy stone dragon, golden eyes | **Ready** (session upload) |
| celestara_006        | Art/Dragons/celestara_006/portrait.png       | White/gold feathered celestial dragon with halo | Pending |
| shadowfang_007       | Art/Dragons/shadowfang_007/portrait.png      | Black/dark purple dragon with glowing purple void flames | **Ready** (session upload) |

## Animation Videos

| Dragon ID       | idle_anim.mp4 | attack_anim.mp4 |
|-----------------|--------------|-----------------|
| voltaris_001    | ✗ pending    | ✗ pending       |
| frostfang_002   | ✓            | ✗ pending       |
| magmaclaw_003   | ✓            | ✓               |
| tempest_glacion_004 | ✗ pending | ✗ pending      |
| stonehide_005   | ✓            | ✓               |
| celestara_006   | ✓            | ✓               |
| shadowfang_007  | ✓            | ✗ pending       |
